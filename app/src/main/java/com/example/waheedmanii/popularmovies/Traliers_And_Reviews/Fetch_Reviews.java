...
import com.example.waheedmanii.popularmovies.Adapters.ReviewAdapter;
...
public class Fetch_Reviews {
    ...
    public Fetch_Reviews(Context context, Movie movie, LinearListView Review_List) {
